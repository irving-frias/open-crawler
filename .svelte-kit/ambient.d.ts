...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__tanstack_virtual_core: string;
	...
	export const npm_package_dependencies__tauri_apps_plugin_fs: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__tanstack_virtual_core: string;
		...
		TERM: string;
		TMPDIR: string;
		npm_package_dependencies__tauri_apps_plugin_fs: string;
		NODE: string;
		COLORTERM: string;
		NODE_PATH: string;
